...
The current unified App chart source version is `0.1.20` with `appVersion` `2026-07-21`. It includes the mandatory authenticated MCP Proxy, OAuth/OIDC discovery and authorization routing, and `/mcp` exposure. App API is pinned to `2026-07-21.03-43-45.2b9048e` and MCP Proxy to `2026-07-21.03-45-50.384afa0`; chart version changes do not authorize invented component image tags, and production deployment values must continue to avoid image overrides.
