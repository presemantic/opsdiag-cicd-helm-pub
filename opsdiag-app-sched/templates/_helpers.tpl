...
{{- define "opsdiag-app-sched.serviceAccountName" -}}
...
{{- define "opsdiag-app-sched.resources" -}}
{{- if .Values.resources -}}
...
{{- define "opsdiag-app-sched.affinity" -}}
{{- if .Values.affinity -}}
